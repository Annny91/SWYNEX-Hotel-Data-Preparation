# SWYNEX Internship — Task 1: Data Preparation
...
The original public dataset contains 119,390 booking records and 32 variables. The source describes hotel demand data from a resort hotel and a city hotel, covering bookings due to arrive between July 2015 and August 2017.
...
* `reservation_status_date` was converted to a proper datetime type
